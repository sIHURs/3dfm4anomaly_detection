...
from factory.gsplat_utils.colmap import Dataset, Parser
from factory.gsplat_utils.traj import (
...
from factory.gsplat_utils.utils import AppearanceOptModule, CameraOptModule, knn, rgb_to_sh, set_random_seed
...
from factory.gsplat_utils.gsplat_viewer import GsplatViewer, GsplatRenderTabState
...
class Config:
    ...
    white_bkgd: bool = False   # add this
...
class Runner:
    ...
    def train(self):
        ...
        for step in pbar:
            ...
            elif getattr(cfg, "white_bkgd", False):
                bkgd = torch.ones(1, 3, device=device)
            else:
                bkgd = torch.zeros(1, 3, device=device)   # default black (or keep original behavior)
