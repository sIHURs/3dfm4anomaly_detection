...
from factory.gaussian_splatting.scene.gaussian_model import BasicPointCloud
...
def training(dataset, opt, pipe, testing_iterations, saving_iterations, checkpoint_iterations, checkpoint, debug_from):
    ...
    if args.random_init_pcd:
        ...
        gaussians.create_from_pcd(pcd, scene.train_cameras_for_randon_pcd, scene.cameras_extent)
