...
from vggtx.vggt.models.aggregator import Aggregator
from vggtx.vggt.heads.camera_head import CameraHead
from vggtx.vggt.heads.dpt_head import DPTHead
from vggtx.vggt.heads.track_head import TrackHead
...
class VGGT(nn.Module, PyTorchModelHubMixin):
    ...
    def forward(self, images: torch.Tensor, query_points: torch.Tensor = None, verbose: bool = False):
        ...
        with torch.inference_mode():
            for k in aggregated_tokens_list.keys():
                aggregated_tokens_list[k] = aggregated_tokens_list[k].to(images.device)
