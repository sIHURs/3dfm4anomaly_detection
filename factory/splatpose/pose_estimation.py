...
def main_pose_estimation(cur_class, 
    ...
    output_dir = os.path.join(model_dir_location, gs_dir)
    ...
    if retrieval == "loftr":
        ...
        print("num train imgs:", train_imgs.shape[0])
        assert train_imgs.shape[0] == train_poses.shape[0], "N mismatch between train_imgs and train_poses"
    elif retrieval == "vggt":
    ...
    for i in tqdm(range(len(testset))):
        ...
        if retrieval == "loftr":
            ...
            # c2w_init = pose_retrieval_loftr(matcher, train_imgs * 255, obs_img * 255, train_poses)
            ...
            c2w_init_idx = pose_retrieval_loftr(matcher, train_imgs, obs_img)
