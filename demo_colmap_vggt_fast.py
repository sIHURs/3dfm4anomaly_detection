...
from factory.vggt_fast.vggt.models.vggt import VGGT
from factory.vggt_fast.vggt.utils.load_fn import load_and_preprocess_images_square
from factory.vggt_fast.vggt.utils.pose_enc import pose_encoding_to_extri_intri
from factory.vggt_fast.vggt.utils.geometry import unproject_depth_map_to_point_map
from factory.vggt_fast.vggt.utils.helper import create_pixel_coordinate_grid, randomly_limit_trues
from factory.vggt_fast.vggt.dependency.track_predict import predict_tracks
from factory.vggt_fast.vggt.dependency.np_to_pycolmap import batch_np_matrix_to_pycolmap, batch_np_matrix_to_pycolmap_wo_track
...
def demo_fn(args):
    ...
    ckpt_path = "/home/wangyifa/tmp/3dfm4anomaly_detection/factory/vggt_fast/vggt/ckpt/model_tracker_fixed_e20.pt"
