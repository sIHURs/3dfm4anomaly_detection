...
pre_parser.add_argument("-skip", type=int, help="only 3dgs training", default=1)
...
if lego_args.skip:
    print("finish with 3dgs training")
else:
    ...
    test_images, reference_images, all_labels, gt_masks, times, filenames = main_pose_estimation(cur_class=config["classname"],
